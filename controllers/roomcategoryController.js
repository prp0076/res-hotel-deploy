import categoryModel from "../models/roomCatModel.js";
...
// get all cat
export const RoomcategoryControlller = async (req, res) => {
  try {
...
// single category
export const singleRoomCategoryController = async (req, res) => {
  try {
